...
public class DiffChecker {
  ...
  public static String SQL_MIST_COUNT = "select tmp1.region as REG, " +
      "tmp1.MISTAKES as MISTAKES, " +
      "tmp2.COUNT as ALL" +
      "from" +
      "(select region, sum(count) as MISTAKES from" +
      ...
      "(select substr(inn_2,0,2) as region) group by region) tmp2" +
